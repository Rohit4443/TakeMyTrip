...
extension UILabel {
    ...
    open func setAttributed(str1:String, font1:UIFont?, color1:UIColor, str2:String, font2:UIFont?, color2:UIColor,str3:String, font3:UIFont?, color3:UIColor)  {
        ...
        let attributed4 = NSMutableAttributedString(string: "", attributes: [
        .font: font1 ?? UIFont(), .foregroundColor: color1])
        let attributed5 = NSMutableAttributedString(string: str3, attributes: [
